...
public class PermissionService {
    ...
    public void initializeDefaultPermissions() {
        ...
        // New permissions (use H and I to avoid conflicts)
        createPermissionIfNotExists("H", "CREATE_TEACHER", "Create and manage teacher details");
        createPermissionIfNotExists("I", "ENTER_MARKS", "Enter or update student marks per subject by teacher");
    }
